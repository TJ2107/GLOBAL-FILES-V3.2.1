...
export const DataTable: React.FC<DataTableProps> = ({ data, setData, onUpdateRow, filters, onFilterChange, onApplyFilters }) => {
  ...
  const hasAnyActiveFilter = Object.keys(filters).length > 0 || colorFilter !== null || isColorSorted;
             ...
             <div className="flex items-center gap-2">
               ...
               {hasAnyActiveFilter && (
                 <button 
                   ...
                   className="flex items-center gap-2 px-4 py-2 bg-rose-500 text-white rounded-xl text-xs font-black hover:bg-rose-600 shadow-md transition-all active:scale-95 animate-in zoom-in"
        ...
        <div className="flex items-center gap-3 flex-wrap w-full lg:w-auto">
          ...
          <div className="relative flex-grow sm:flex-grow-0" ref={viewsMenuRef}>
            <button 
              ...
              className={`w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 border rounded-xl shadow-sm text-xs font-black transition-all duration-200 bg-white border-gray-200 text-gray-700 hover:bg-gray-50`}
            >
            ...
            {isViewsMenuOpen && (
              <div className="absolute top-full right-0 mt-2 w-72 bg-white border border-gray-100 rounded-2xl shadow-2xl z-50 p-4 animate-in zoom-in-95 origin-top-right">
          ...
          <div className="relative flex-grow sm:flex-grow-0" ref={colorMenuRef}>
             <button 
               ...
               className={`w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 border rounded-xl shadow-sm text-xs font-black transition-all duration-200 ${colorFilter ? 'bg-indigo-600 border-indigo-600 text-white shadow-indigo-200 shadow-lg' : 'bg-white border-gray-200 text-gray-700 hover:bg-gray-50'}`}
             >
             ...
             {isColorMenuOpen && (
               <div className="absolute top-full right-0 mt-2 w-64 bg-white border border-gray-100 rounded-2xl shadow-2xl z-50 p-2 animate-in zoom-in-95 origin-top-right">
                 <div className="text-[10px] font-black text-gray-400 px-3 py-2 uppercase tracking-widest border-b border-gray-50 mb-1">Filtrer par statut technique (X)</div>
          ...
          <button 
            ...
            className={`flex-grow sm:flex-grow-0 flex items-center justify-center gap-2 px-4 py-2 border rounded-xl shadow-sm text-xs font-black transition-all duration-200 ${isColorSorted ? 'bg-orange-500 border-orange-500 text-white shadow-orange-200 shadow-lg' : 'bg-white border-gray-200 text-gray-700 hover:bg-gray-50'}`}
